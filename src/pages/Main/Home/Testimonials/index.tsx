...
export const Testimonials = () => {
  return (
    <section>
        ...
        <div className="['Sans'] flex-shrink-0 w-[32rem] h-[3rem] m-auto text-black/[.60] text-center font-['Open leading-[normal]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</div>
