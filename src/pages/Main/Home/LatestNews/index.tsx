...
export const LatestNews = () => {
    return (
        <div className='pt-8 pb-8'>
            <div className='flex flex-col sm:flex-col md:flex-row justify-between items-strech'>
                ...
                <div>
                    <Button className="background flex-shrink-0 w-full sm:w-[11.375rem] h-[3.75rem] rounded-[0.875rem] bg-[#6c5dd3] text-white text-bold    " >View more</Button>
                </div>
            </div>
