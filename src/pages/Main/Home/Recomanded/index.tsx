...
export const Recomended: FC = () => {
    return (
        <div className="rounded-[14px]  w-full h-auto sm:h-auto md:h-auto lg:h-[443px] relative " style={{backgroundColor:'#fff6ef'}}>
            <svg
                        width={200}
                        height={182}
                        viewBox="0 0 153 172"
                        ...
                        className="absolute top-0 right-0 rounded-[14px]"
                    >
            ...
            <div className="p-4 items-center relative">
                ...
                <div className=" pt-6 md:pt-8 lg:pt-10 xl:pt-12 pb-6 relative">
                    <svg
                    // grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-4
                        width={150}
                        height={150}
                        viewBox="0 0 153 172"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className="absolute bottom-0 left-[-16px] rounded-[14px]"
                    >
                        <circle cx={45} cy={108} r={108} fill="#F5DCC8" />
                    </svg>
                    
                    <div  className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 m-auto relative ">
                        {recomendation.map((item, index) => (
                            <div key={index} className="rounded-lg overflow-hidden bg-gray-400 border-4 border-solid border-white  w-[8.5rem] h-[13rem] relative flex m-auto ">
                                <img
                                    src={item.image}
                                    alt={item.image}
                                    className="object-cover w-[15rem] h-[190.77px]"
                                />
                            </div>
                             ))}
                        </div>
